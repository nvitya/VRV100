...
module VRV1_104_4M (
  ...
  wire       [5:0]    _zz_when_VRV1_104_l207;
  wire                when_VRV1_104_l207;
  wire                when_VRV1_104_l211;
  ...
  always @(*) begin
    ...
    if(when_VRV1_104_l207) begin
      resetCtrl_mainClkResetUnbuffered = 1'b1;
    end
  end

  assign _zz_when_VRV1_104_l207[5 : 0] = 6'h3f;
  assign when_VRV1_104_l207 = (resetCtrl_systemClkResetCounter != _zz_when_VRV1_104_l207);
  assign when_VRV1_104_l211 = io_asyncReset_buffercc_io_dataOut;
  ...
  assign system_mainBusDecoder_logic_hits_0 = ((system_mainBusDecoder_logic_masterPipelined_cmd_payload_address & (~ 32'h00007fff)) == 32'h80000000);
  always @(*) begin
...
module MuraxPipelinedMemoryBusRam (
  ...
  initial begin
    $readmemb("VRV1_104_4M.v_toplevel_system_ocram_ram_symbol0.bin",ram_symbol0);
    $readmemb("VRV1_104_4M.v_toplevel_system_ocram_ram_symbol1.bin",ram_symbol1);
    $readmemb("VRV1_104_4M.v_toplevel_system_ocram_ram_symbol2.bin",ram_symbol2);
    $readmemb("VRV1_104_4M.v_toplevel_system_ocram_ram_symbol3.bin",ram_symbol3);
  end
  always @(*) begin
