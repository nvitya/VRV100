...
class VRV1_103(config: VRV1_103Config) extends Component
{
  import config._
  ...
  val system = new ClockingArea(systemClockDomain) {
    ...
    val ocram = new MuraxPipelinedMemoryBusRam(
      ...
      onChipRamHexFile = null, //"VRV1_103_1M.hex",
...
object VRV1_103
{
  def main(args: Array[String])
  {
    ...
    config.generateVerilog(
	 {
      val toplevel = new VRV1_103(VRV1_103Config.default)
      HexTools.initRam(toplevel.system.ocram.ram, "VRV1_103_1M.hex", 0x80000000l)
      toplevel
    })
  }
}
