...
module VRV1_241 (
  ...
  wire       [5:0]    _zz_when_VRV1_241_l237;
  wire                when_VRV1_241_l237;
  wire                when_VRV1_241_l241;
  ...
  reg        [11:0]   axi_ram_io_axi_arbiter_io_output_arw_rData_addr;
  ...
  BufferCC_4 io_coreInterrupt_buffercc (
  ...
  always @(*) begin
    ...
    if(when_VRV1_241_l237) begin
      resetCtrl_systemResetUnbuffered = 1'b1;
    end
  end

  assign _zz_when_VRV1_241_l237[5 : 0] = 6'h3f;
  assign when_VRV1_241_l237 = (resetCtrl_systemResetCounter != _zz_when_VRV1_241_l237);
  assign when_VRV1_241_l241 = io_asyncReset_buffercc_io_dataOut;
  ...
  assign axi_ram_io_axi_arbiter_io_readInputs_0_ar_payload_addr = axi4ReadOnlyDecoder_1_io_outputs_1_ar_validPipe_payload_addr[11:0];
  assign _zz_io_readInputs_0_ar_payload_id_1[2 : 0] = 3'b000;
  assign axi_ram_io_axi_arbiter_io_sharedInputs_0_arw_payload_addr = dbus_axi_decoder_io_sharedOutputs_1_arw_validPipe_payload_addr[11:0];
...
module Axi4SharedDecoder (
  ...
  assign _zz_decodedCmdSels_2 = (io_input_arw_payload_addr & (~ 32'h00000fff));
...
module Axi4ReadOnlyDecoder (
  ...
  assign decodedCmdSels = {(((io_input_ar_payload_addr & (~ 32'h01ffffff)) == 32'h40000000) && io_input_ar_valid),{(((io_input_ar_payload_addr & (~ 32'h00000fff)) == 32'h10000000) && io_input_ar_valid),(((io_input_ar_payload_addr & (~ 32'h00000fff)) == 32'h80000000) && io_input_ar_valid)}};
...
module Axi4SharedOnChipRam (
  ...
  assign _zz_Axi4Incr_result_12 = Axi4Incr_baseIncr[5 : 0];
  initial begin
    $readmemb("VRV1_241.v_toplevel_axi_bootrom_ram_symbol0.bin",ram_symbol0);
    $readmemb("VRV1_241.v_toplevel_axi_bootrom_ram_symbol1.bin",ram_symbol1);
    $readmemb("VRV1_241.v_toplevel_axi_bootrom_ram_symbol2.bin",ram_symbol2);
    $readmemb("VRV1_241.v_toplevel_axi_bootrom_ram_symbol3.bin",ram_symbol3);
  end
  always @(*) begin
    _zz_ram_port0 = {_zz_ramsymbol_read_3, _zz_ramsymbol_read_2, _zz_ramsymbol_read_1, _zz_ramsymbol_read};
  end
