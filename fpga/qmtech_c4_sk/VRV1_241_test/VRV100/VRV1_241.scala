...
Integrater Peripherals:
 ...
 0x80000000: OCRAM, 4 kByte, the first 1k reserved for bootloader
...
object VRV1_241Config
{
  def default =
  {
    val config = VRV1_241Config(
...
class VRV1_241(config: VRV1_241Config) extends Component
{
  //Legacy constructor
  def this(axiFrequency: HertzNumber)
  {
    this(VRV1_241Config.default.copy(axiFrequency = axiFrequency))
  }
...
object VRV1_241
{
  def main(args: Array[String])
  {
    ...
    config.generateVerilog(
	 {
      val toplevel = new VRV1_241(VRV1_241Config.default)
      HexTools.initRam(toplevel.axi.bootrom.ram, "VRV1_241_1M.hex", 0x80000000l)
      toplevel
    })
  }
}
