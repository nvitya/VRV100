...
module VRV134 (
  ...
  wire       [5:0]    _zz_when_VRV134_l254;
  wire                when_VRV134_l254;
  wire                when_VRV134_l258;
  ...
  always @(*) begin
    ...
    if(when_VRV134_l254) begin
      resetCtrl_systemResetUnbuffered = 1'b1;
    end
  end

  assign _zz_when_VRV134_l254[5 : 0] = 6'h3f;
  assign when_VRV134_l254 = (resetCtrl_systemResetCounter != _zz_when_VRV134_l254);
  assign when_VRV134_l258 = io_asyncReset_buffercc_io_dataOut;
...
module Axi4SharedOnChipRam (
  ...
  assign _zz_Axi4Incr_result_12 = Axi4Incr_baseIncr[5 : 0];
  initial begin
    $readmemb("VRV134.v_toplevel_axi_bootrom_ram_symbol0.bin",ram_symbol0);
    $readmemb("VRV134.v_toplevel_axi_bootrom_ram_symbol1.bin",ram_symbol1);
    $readmemb("VRV134.v_toplevel_axi_bootrom_ram_symbol2.bin",ram_symbol2);
    $readmemb("VRV134.v_toplevel_axi_bootrom_ram_symbol3.bin",ram_symbol3);
  end
  always @(*) begin
    _zz_ram_port0 = {_zz_ramsymbol_read_3, _zz_ramsymbol_read_2, _zz_ramsymbol_read_1, _zz_ramsymbol_read};
  end
