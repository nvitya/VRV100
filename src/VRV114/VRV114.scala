...
class VRV114(config: VRV114Config) extends Component
{
  //Legacy constructor
  def this(axiFrequency: HertzNumber)
  {
    this(VRV114Config.default.copy(axiFrequency = axiFrequency))
  }
...
//    val coreResetUnbuffered = False
  ...
  val axi = new ClockingArea(axiClockDomain) {
    ...
    axiCrossbar.addConnections(
      core.iBus       -> List( bootrom.io.axi, ram.io.axi),
      core.dBus       -> List( bootrom.io.axi, ram.io.axi, apbBridge.io.axi, apbBridge2.io.axi )
    )
...
object VRV114
{
  def main(args: Array[String])
  {
    ...
    config.generateVerilog(
	 {
      val toplevel = new VRV114(VRV114Config.default)
      HexTools.initRam(toplevel.axi.bootrom.ram, "VRV114_1M.hex", 0x80000000l)
      toplevel
    })
  }
}
