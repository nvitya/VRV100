...
module VRV143 (
  ...
  wire       [5:0]    _zz_when_VRV143_l262;
  wire                when_VRV143_l262;
  wire                when_VRV143_l266;
  ...
  BufferCC_6 io_asyncReset_buffercc (
  ...
  BufferCC_7 io_coreInterrupt_buffercc (
  ...
  always @(*) begin
    ...
    if(when_VRV143_l262) begin
      resetCtrl_systemResetUnbuffered = 1'b1;
    end
  end

  assign _zz_when_VRV143_l262[5 : 0] = 6'h3f;
  assign when_VRV143_l262 = (resetCtrl_systemResetCounter != _zz_when_VRV143_l262);
  assign when_VRV143_l266 = io_asyncReset_buffercc_io_dataOut;
...
module PinsecTimerCtrl (
  ...
  BufferCC_5 io_external_buffercc (
...
module Apb3GpioSetClear (
  ...
  BufferCC_3 io_gpio_read_buffercc (
...
module Axi4SharedOnChipRam (
  ...
  assign _zz_Axi4Incr_result_12 = Axi4Incr_baseIncr[5 : 0];
  initial begin
    $readmemb("VRV143.v_toplevel_axi_bootrom_ram_symbol0.bin",ram_symbol0);
    $readmemb("VRV143.v_toplevel_axi_bootrom_ram_symbol1.bin",ram_symbol1);
    $readmemb("VRV143.v_toplevel_axi_bootrom_ram_symbol2.bin",ram_symbol2);
    $readmemb("VRV143.v_toplevel_axi_bootrom_ram_symbol3.bin",ram_symbol3);
  end
  always @(*) begin
    _zz_ram_port0 = {_zz_ramsymbol_read_3, _zz_ramsymbol_read_2, _zz_ramsymbol_read_1, _zz_ramsymbol_read};
  end
