...
Integrater Peripherals:
 ...
 0x80000000: OC-RAM, 4 kByte, the first 1k reserved for the boot loader
...
object VRV1_441Config
{
  def default =
  {
    val config = VRV1_441Config(
...
class VRV1_441(config: VRV1_441Config) extends Component
{
  //Legacy constructor
  def this(axiFrequency: HertzNumber)
  {
    this(VRV1_441Config.default.copy(axiFrequency = axiFrequency))
  }
...
object VRV1_441
{
  def main(args: Array[String])
  {
    ...
    config.generateVerilog(
	 {
      val toplevel = new VRV1_441(VRV1_441Config.default)
      HexTools.initRam(toplevel.axi.ocram.ram, "VRV1_441_1M.hex", 0x80000000l)
      toplevel
    })
  }
}
