...
module VRV1_443 (
  ...
  wire       [5:0]    _zz_when_VRV1_443_l261;
  wire                when_VRV1_443_l261;
  wire                when_VRV1_443_l265;
  ...
  always @(*) begin
    ...
    if(when_VRV1_443_l261) begin
      resetCtrl_systemResetUnbuffered = 1'b1;
    end
  end

  assign _zz_when_VRV1_443_l261[5 : 0] = 6'h3f;
  assign when_VRV1_443_l261 = (resetCtrl_systemResetCounter != _zz_when_VRV1_443_l261);
  assign when_VRV1_443_l265 = io_asyncReset_buffercc_io_dataOut;
  ...
  assign axi_ocram_io_axi_arbiter_io_readInputs_0_ar_payload_addr = axi4ReadOnlyDecoder_1_io_outputs_0_ar_validPipe_payload_addr[13:0];
...
module Axi4SharedOnChipRam (
  ...
  assign _zz_Axi4Incr_result_12 = Axi4Incr_baseIncr[5 : 0];
  initial begin
    $readmemb("VRV1_443.v_toplevel_axi_ocram_ram_symbol0.bin",ram_symbol0);
    $readmemb("VRV1_443.v_toplevel_axi_ocram_ram_symbol1.bin",ram_symbol1);
    $readmemb("VRV1_443.v_toplevel_axi_ocram_ram_symbol2.bin",ram_symbol2);
    $readmemb("VRV1_443.v_toplevel_axi_ocram_ram_symbol3.bin",ram_symbol3);
  end
  always @(*) begin
