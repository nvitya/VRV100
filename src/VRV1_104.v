...
module MuraxPipelinedMemoryBusRam (
  ...
  initial begin
    $readmemb("VRV1_104.v_toplevel_system_ocram_ram_symbol0.bin",ram_symbol0);
    $readmemb("VRV1_104.v_toplevel_system_ocram_ram_symbol1.bin",ram_symbol1);
    $readmemb("VRV1_104.v_toplevel_system_ocram_ram_symbol2.bin",ram_symbol2);
    $readmemb("VRV1_104.v_toplevel_system_ocram_ram_symbol3.bin",ram_symbol3);
  end
  always @(*) begin
