...
object VRV1_365Config
{
  def default =
  {
    val config = VRV1_365Config(
...
class VRV1_365(config: VRV1_365Config) extends Component
{
  //Legacy constructor
  def this(axiFrequency: HertzNumber)
  {
    this(VRV1_365Config.default.copy(axiFrequency = axiFrequency))
  }
...
object VRV1_365
{
  def main(args: Array[String])
  {
    ...
    config.generateVerilog(
	 {
      val toplevel = new VRV1_365(VRV1_365Config.default)
      HexTools.initRam(toplevel.axi.ocram.ram, "VRV1_365_4M.hex", 0x80000000l)
      toplevel
    })
  }
}
