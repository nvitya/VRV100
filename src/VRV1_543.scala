...
object VRV1_543Config
{
  def default =
  {
    val config = VRV1_543Config(
...
class VRV1_543(config: VRV1_543Config) extends Component
{
  //Legacy constructor
  def this(axiFrequency: HertzNumber)
  {
    this(VRV1_543Config.default.copy(axiFrequency = axiFrequency))
  }
...
object VRV1_543
{
  def main(args: Array[String])
  {
    ...
    config.generateVerilog(
	 {
      val toplevel = new VRV1_543(VRV1_543Config.default)
      HexTools.initRam(toplevel.axi.ocram.ram, "VRV1_543_1M.hex", 0x80000000l)
      toplevel
    })
  }
}
